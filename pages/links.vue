<template>
  <div>
    <div>
      <ul>
        <li>
          <nuxt-link to='/xss/show?name=<img%20src%3D"hoge"%20onerror%3Dalert%281%29>'>DOM-Based-XSS</nuxt-link>
        </li>
        <li>
          <nuxt-link to='/xss/show?name=<img src="hoge" onerror=alert(1)>'>DOM-Based-XSS 2</nuxt-link>
        </li>
        <li>
